...
class ArticleRestControllerGetArticleTest {
    ...
    void getArticle_success() throws Exception {
        ...
        // ## Act ##
        var actual = mockMvc.perform(get("/articles/{articleId}", expectedArticle1.getId()).contentType(MediaType.APPLICATION_JSON));
    ...
    void getArticle_404() throws Exception {
        ...
        // ## Act ##
        var actual = mockMvc.perform(get("/articles/{articleId}", invalidArticleId).contentType(MediaType.APPLICATION_JSON));
