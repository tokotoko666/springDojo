...
@Import({ArticleService.class, ArticleCommentService.class, UserService.class, PasswordEncoderConfig.class})
class ArticleCommentServiceTest {
    ...
    void findByArticleId_invalidArticleId() {
        ...
        // ## Act ##
        // ## Assert ##
        assertThrows(ResourceNotFoundException.class, () -> cut.findByArticleId(0L));
    }
}